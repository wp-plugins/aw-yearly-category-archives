...
The first shortcode is [aw\_year\_links cat=\"X\" postslug=\"slug-to-post-or-page\"], which is used to build and display the year links.  
...
The second shortcode is [aw\_show\_posts cat=\"X\" readmore=\"Continue Reading\" publishedon=\"n/j/Y\"], which is used to display the post content after click a year link.  
...
To install the plugin follow these instructions:  
    ...
    Upload the folder aw\_wp\_yearly\_category\_archives to your /wp-content/plugins/ folder.  
