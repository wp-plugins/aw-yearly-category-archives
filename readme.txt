...
##### If you would like to contribute to the plugin, you may do so here: [https://github.com/andywarren/aw-yearly-category-archives](https://github.com/andywarren/aw-yearly-category-archives).  Currently the most important need is to add pagination to the archived posts.#####
